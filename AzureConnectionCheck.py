...
CONTAINER_NAME = os.getenv('CONTAINER_NAME') # ¡CRUCIAL QUE ESTÉ BIEN CONFIGURADO!
...
def connect_to_storage():
    ...
    try:
        ...
        print(f"   Obteniendo cliente para el contenedor: {CONTAINER_NAME}")
        container_client = blob_service_client.get_container_client(CONTAINER_NAME)

        # Lista los blobs (archivos) en el contenedor
        print(f"\n📂 Archivos en el contenedor '{CONTAINER_NAME}':")
